...
import { type EnvironmentModuleOptions } from './auth.types'
import { Global, Logger, Module, type DynamicModule } from '@nestjs/common'
import { EnvironmentService } from './auth.service'
import { injectValuesFromFileIfExist, provideEnvironmentValidation, } from './auth.helpers'
